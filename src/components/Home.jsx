...
export default function Home() {
  return (
    <div className="text-gray-900 dark:text-gray-100">
      {/* HERO */}
      <section className="bg-gradient-to-b from-blue-600 to-blue-700 text-white dark:from-blue-700 dark:to-blue-800">
        <div className="max-w-6xl mx-auto px-6 py-14 grid md:grid-cols-2 gap-8 items-center">
          <div>
            ...
            <p className="mt-4 text-blue-100 dark:text-blue-200 text-lg">
      ...
      {/* NOTA LEGAL CORTA */}
      <section className="py-8 bg-amber-50 dark:bg-amber-900 border-y border-amber-200 dark:border-amber-700">
        <div className="max-w-6xl mx-auto px-6 text-amber-900 dark:text-amber-100 text-sm">
          <p>
...
function Step({ n, title, text }) {
  return (
    <li className="bg-white dark:bg-gray-800 rounded-xl shadow p-6">
